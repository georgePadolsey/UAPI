...
/*	public boolean playerIsInArena(String p) {
	...
	*/
	...
	/**
	 * Get Entity From A UUID code, If you know the world that the entity is in I recomend {@link #getEntityFromUUID(java.util.UUID, String)}
	 * @param uuid
	 * 	- The UUID of an entity
	 * @return Entity
	 * 	- The Entity With That UUID
	 * @see #getEntityFromUUID(java.util.UUID, String)
	 * @since 1.0
	 */
